...
export const publications = [
  {
    ...
    venue: "Arxiv",
    year: 2026,
    keywords: ["LLM Agents", "Personal AI Assistant", "Scientific Instrument", "Mechanisms"],
    githubStars: "https://img.shields.io/github/stars/zjunlp/Mechanist?style=flat",
    links: [
      { text: "Paper", url: "https://arxiv.org/abs/2608.12036" },
      { text: "Code", url: "https://github.com/zjunlp/Mechanist" },
    ],
    arxivId: "2608.12036",
    minCiteCount: 0,
  },
  ...
  },
  {
    ...
    venue: "ICLR 2026 [CCF-A] Workshop LLA & NLPCC 2026 [CCF-C]",
    year: 2026,
    keywords: ["Agentic Memory", "Long-term Memory", "Agent Evaluation", "Benchmark"],
    githubStars: "https://img.shields.io/github/stars/zjunlp/MobileMem?style=flat",
    links: [
      { text: "Code", url: "https://github.com/zjunlp/MobileMem" },
    ],
  },
  {
    id: 9,
